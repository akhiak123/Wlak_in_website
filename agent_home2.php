...
if($agentquery->num_rows>0)
{
  ...
  echo '<td><a href="agents.php" class="btn btn-primary" style="background-color:005697;" name="submit">Submit</td></tr>';
...
if(isset($_POST['submit'])){
  echo 'alert("hello")';
      $name=$_POST['agent'];
    $sql="update regform set agentname='$name' and visitedornot='1' where reg_id='$num'";
